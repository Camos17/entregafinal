...
@Service
public class DentistServiceImplOld implements com.entregafinalspring.entregafinal.services.DentistServiceOld {

    final static Logger logger = Logger.getLogger(DentistServiceImplOld.class);
